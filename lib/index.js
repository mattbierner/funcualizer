...
*/
functionalizer.dynamic_pre = methodName =>
    (self, ...args) =>
...
*/
functionalizer.dynamic_pre$ = (methodName, arity) => {
    switch (arity) {
    ...
    default: return functionalizer.dynamic_pre(methodName);
    }
};
...
/**
    ...
    @see `dynamic_pre`
*/
functionalizer.dynamic_post = methodName =>
    (...args) => {
        const self = args.pop();
...
*/
functionalizer.dynamic_post$ = (methodName, arity) => {
    switch (arity) {
    case 0: return (self) => self[methodName]();
    ...
    default: return functionalizer.dynamic_post(methodName);
    }
};
